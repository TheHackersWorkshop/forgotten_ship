...
def main():
    ...
    save_item_positions_to_settings(item_positions)

    print("Welcome to Forgotten Ship.")
    print(dialogue_data.get('intro', "Intro text not found."))
    ...
    while player.is_alive():
        ...
        description, room_dialogue = get_room_dialogue(room_name, dialogue_data)
        ...
        if room_data.get("compartment"):
            print(f"Compartment contains: {', '.join(room_data['compartment'])}")
        if room_dialogue:
            print("Dialogue:")
